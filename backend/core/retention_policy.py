...
COLLECTIONS: Dict[str, CollectionPolicy] = {
    ...
    "contact_mutes": CollectionPolicy(
        ...
        enforcement=EnforcementStatus.ENFORCED,
        engine1_step=None,
        allowed_fields="seal, created_at, muted_until, updated_at",
        notes="Blind mute seal with optional expiry.",
    ),
    "conversation_mutes": CollectionPolicy(
        name="conversation_mutes",
        tier=RetentionTier.SOCIAL_GRAPH,
        max_lifetime="until_user_unmutes_or_expiry",
        ttl_field=None,
        enforcement=EnforcementStatus.ENFORCED,
        engine1_step=None,
        allowed_fields="seal, user_id, conversation_id, duration, muted_until, created_at, updated_at",
        notes="Per-chat notification mute with optional expiry.",
    ),
    "signal_devices": CollectionPolicy(
        name="signal_devices",
        tier=RetentionTier.SOCIAL_GRAPH,
        max_lifetime="until_user_unlinks_or_account_delete",
        ttl_field=None,
        enforcement=EnforcementStatus.ENFORCED,
        engine1_step=None,
        allowed_fields="user_id, device_id, device_name, platform, is_primary, created_at, last_seen_at",
        notes="Linked device registry — Q.51.",
    ),

...
COLLECTIONS: Dict[str, CollectionPolicy] = {
    ...
    "contacts": CollectionPolicy(
        ...
        enforcement=EnforcementStatus.ENFORCED,
        engine1_step=None,
        allowed_fields="user_id, contact_id, blocked, muted, created_at",
        notes="Accepted metadata tradeoff v1.0 — who you know.",
    ),
    ...
    "conversations": CollectionPolicy(
        ...
        enforcement=EnforcementStatus.ENFORCED,
        engine1_step=None,
        allowed_fields="conversation_id, participants, is_group, admin_id, created_at, last_activity_at, expires_at",
    ),

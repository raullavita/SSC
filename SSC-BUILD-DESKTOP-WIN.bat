...
copy /Y dist\SSC-Setup-1.0.12.exe C:\Users\smash\Desktop\SSC\SSC-Setup-1.0.12.exe
echo.
echo DONE: frontend\desktop\dist\SSC-Setup-1.0.12.exe
echo       C:\Users\smash\Desktop\SSC\SSC-Setup-1.0.12.exe
endlocal
...
QtObject {
    ...
    readonly property color onPrimary: "#041510"
    readonly property color secondary: "#53BDEB"
    readonly property color background: "#0B141A"
    readonly property color onBackground: "#E9EDEF"
    readonly property color surface: "#111B21"
    readonly property color onSurface: "#E9EDEF"
    readonly property color surfaceVariant: "#202C33"
    readonly property color onSurfaceVariant: "#8696A0"
